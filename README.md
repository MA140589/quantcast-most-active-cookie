# most-active-cookie
Process a cookie log file and return the most active cookie for a specific day
...
- Still stand at the directory: most-active-cookie
- Run the compiled jar file:

~~~
java -jar target/quantcast-most-active-cookie-1.0-SNAPSHOT.jar -f csv-file-path -d selected-date
~~~

- Example:

~~~
java -jar target/quantcast-most-active-cookie-1.0-SNAPSHOT.jar -f src/main/resources/logs/cookie_log.csv -d 2018-12-09
~~~
